...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'com.dropsheet.app'),
     ...
     */
    'description' => env('NATIVEPHP_APP_DESCRIPTION', 'DropSheet – trích xuất đơn hàng drop-ship từ PDF sang Google Sheets'),
